...
const Board = () => {
  ...
  return (
    <>
      <div className="flex align-center place-content-between w-full">
        <div className="flex align-center">
          ...
          {isShownHoverContent ? (
            <span className="flex items-center">Ajouter au Favoris</span>
          ) : null}
        </div>
        <div className="flex align-center">
          {isHovering ? (
            <span className="flex items-center">Supprimer le tableau</span>
          ) : null}
          <IconButton
